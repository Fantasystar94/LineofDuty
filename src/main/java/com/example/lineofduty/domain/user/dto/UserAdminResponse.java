...
public class UserAdminResponse {
    ...
    private EnlistmentInfo enlistmentInfo;
    ...
    public UserAdminResponse(User user) {
        ...
        this.enlistmentInfo = null;
    }

    public void setEnlistmentInfo(EnlistmentApplication enlistmentInfo) {
        if (enlistmentInfo != null) {
            this.enlistmentInfo = new EnlistmentInfo(enlistmentInfo);
        }
    }
