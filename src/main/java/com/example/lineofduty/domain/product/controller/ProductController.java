...
public class ProductController {
    ...
    @GetMapping("/products")
    private  ResponseEntity<GlobalResponse<PageResponse<ProductGetAllResponse>>> getProDuctList(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size, @RequestParam(defaultValue = "createdAt") String sort, @RequestParam(defaultValue = "desc") String direction) {
